 ...
 *
 */
class AuthEndpointsApi extends runtime.BaseAPI {
    /**
     */
    ...
    /**
     */
    postLoginRedirectRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters['returnUrl'] != null) {
                queryParameters['returnUrl'] = requestParameters['returnUrl'];
    ...
    postLoginRedirect() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            yield this.postLoginRedirectRaw(requestParameters, initOverrides);
        });
    }
}
